                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link href="/" className="flex items-center gap-2.5 group shrink-0">
                        <motion.div
                            ...
                            className="relative w-14 h-14 flex items-center justify-center overflow-hidden rounded-full shadow-md bg-white border border-slate-200"
                        >
                            <Image 
                                src="/ezybus-logo.png" 
                                alt="EzyBus Logo" 
                    ...
                    <div className="md:hidden flex items-center gap-2">
                        <ThemeToggle />
                        <button
                            className="w-9 h-9 flex items-center justify-center rounded-xl text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors"
